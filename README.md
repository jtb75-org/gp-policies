...
| `WIZ_OUTPOST_CLIENT_ID` | Secret | Client ID for the Outpost Lite runner | Generated by CCR deployment (Terraform output) |
| `WIZ_OUTPOST_CLIENT_SECRET` | Secret | Client Secret for the Outpost Lite runner | Generated by CCR deployment (Terraform output) |
| `WIZ_OUTPOST_ID` | Secret | Outpost ID | Generated by CCR deployment (Terraform output) |
